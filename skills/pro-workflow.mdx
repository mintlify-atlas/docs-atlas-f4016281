---
title: 'Pro Workflow'
description: 'Complete AI coding workflow system with orchestration patterns, learning loops, and cross-agent support'
icon: 'star'
---

## Overview

Pro Workflow is the master skill containing all core patterns for AI-assisted development. It includes the self-correction loop, parallel sessions, context management, learning capture, and multi-phase orchestration.

<Note>
**Works with:** Claude Code, Cursor, Codex, Gemini CLI, and 32+ AI coding agents via SkillKit. Sections marked *(Claude Code)* use features specific to Claude Code — Cursor users can skip those or use noted alternatives.
</Note>
...
Pro Workflow optimizes for that ratio. Every pattern here reduces correction cycles.
...
<Card title="Learn Rule Skill" icon="graduation-cap" href="/skills/learn-rule">
...
<Card title="Parallel Worktrees Skill" icon="code-branch" href="/skills/parallel-worktrees">
...
<Card title="Wrap-Up Skill" icon="check-circle" href="/skills/wrap-up">
...
**Opus 4.6 and Sonnet 4.6** both support adaptive thinking and 1M-token context (as of 2025-08). The 1M context is available as a beta option (via the `context-1m-2025-08-07` beta header); the default context window remains 200K. Sonnet 4.5 (200K context) has been retired from the Max plan in favor of Sonnet 4.6.
...
<Info>
See [Models overview](https://docs.anthropic.com/en/docs/about-claude/models/overview) for current capabilities.
</Info>
...
<Card title="Context Optimizer Skill" icon="gauge-high" href="/skills/context-optimizer">
...
<Card title="Orchestrate Skill" icon="diagram-project" href="/skills/orchestrate">
...
<Steps>
  <Step title="Compound improvements">
    Small corrections lead to big gains
  </Step>
  <Step title="Trust but verify">
    Let AI work, review at checkpoints
  </Step>
  <Step title="Zero dead time">
    Parallel sessions keep momentum
  </Step>
  <Step title="Memory is precious">
    Yours and the AI's
  </Step>
  <Step title="Orchestrate, don't micromanage">
    Wire patterns together, let agents execute
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Wrap-Up Ritual" icon="check-circle" href="/skills/wrap-up">
